...
RUN="java --add-modules java.xml.bind"
...
OUTDIR="./bin"
CLASSPATH=".:$OUTDIR:$HAMCREST:$JUNIT:$AWS:$JACKSONANN:$JACKSONDB:$JACKSONCORE:$APACHELOG:$HTTPCLIENT:$HTTPCLIENTC:$HTTPCORE:$JODATIME:$JAXB:$JAXBR"
